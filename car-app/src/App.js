      ...
      <div className="App">
        <div className="App-header">
          <>
            ...
            >
              {manufacturers.map((m) => (
                <Manufacturer onClick={handleSelectedModel} value={m} pkManufacturer={m.pkManufacturer} key={m.pkManufacturer} label={m.label} />
              ))}
            </List>
          </>
      ...
      <Collapse in={open} onEnter={handleManufacturer} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          {model &&
            model.map((ml) => {
              return (
                <ListItem key={ml.pkModel} button className={classes.nested}>
                  <ListItemIcon>
                    <StarBorder />
                  </ListItemIcon>
